    ...
    <div class="text-center fill-height">
      <div class="row justify-center q-pb-xl">
        <div class="button-container">
          <q-btn :color="audio.isRecording.value ? 'grey-10' : 'light-blue-8'" @click="audio.startRecording"
            class="simple-border">
          ...
          <q-btn :color="audio.isRecording.value ? 'light-blue-8' : 'grey-10'" label="Stop" @click="stopRecording"
            icon="stop" class="simple-border" />
        </div>
      </div>
